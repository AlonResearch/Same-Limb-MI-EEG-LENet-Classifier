...
After analyzing `setup_env.ps1` for a fresh GitHub clone scenario, **the setup script is incomplete** for ensuring proper package and submodule installation. Here's what's missing and what needs to be added.
