...
Terminal usage example:
    python -m mi3_eeg.data_formatting.convert_batch "G:/My Drive/ML/dataset"
"""
...
from mi3_eeg.data_formatting.dataformatter import detect_format, format_and_save
...
def main() -> None:
    ...
    if len(sys.argv) < 2:
        ...
        logger.info("Usage: python -m mi3_eeg.data_formatting.convert_batch <folder_path>")
        sys.exit(1)
