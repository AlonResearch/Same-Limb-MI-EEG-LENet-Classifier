"""Preprocessing module for converting raw MI3 data to model-ready format.
...
def preprocess_and_save(
    ...
    """Preprocess raw MI3 .mat file and save in standardized format.
    ...
    Returns:
        Path to the saved preprocessed .mat file.
